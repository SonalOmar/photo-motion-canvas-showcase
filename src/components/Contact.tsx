    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          {/* Contact Info */}
          <div
            className={`lg:col-span-4 transition-all duration-1000 transform ${
              isVisible
          ...
          >
            ...
            <div className="border-t border-gray-800 pt-8">
              <div className="text-sm text-gray-400 tracking-[0.1em] mb-4">
                FOLLOW
              </div>
              <div className="flex space-x-4">
                ...
                <a
                  href="https://www.linkedin.com/in/kaushi-gupta/"
                  className="text-gray-500 hover:text-yellow-400 transition-colors duration-300"
                >
          ...
          {/* 
          <div
            className={`lg:col-span-8 transition-all duration-1000 transform ${
              isVisible
                ? "translate-x-0 opacity-100"
                : "translate-x-12 opacity-0"
            }`}
          >
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <label className="block text-sm text-gray-400 tracking-[0.1em] mb-3">
                    NAME
                  </label>
                  <Input
                    type="text"
