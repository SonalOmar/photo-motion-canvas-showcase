...
const galleryImages = [
  ...
  {
    id: 18,
    src: "images/product/image12.png",
    // title: "Minimal Watch",
    category: "Product",
    year: "2023",
    shape: "rectangle",
  ...
  {
    id: 24,
    src: "images/product/image13.png",
  ...
  // {
  //   id: 27,
  //   src: "images/product/image10.png",
  ...
  {
    id: 28,
    src: "images/product/image11.png",
    category: "Product",
    // year: "2023",
    shape: "square",
  },
...
const Gallery = () => {
  ...
  const categories = ["All", "Product", "Lifestyle", "Outdoor"];
